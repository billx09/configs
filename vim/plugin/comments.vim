...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$' || file_name =~ '\.cc$' || file_name =~ '\.hh'
  ...
  elseif file_name =~ '\.[kc]\?sh$' || file_name =~ '\.pl$' || file_name =~ '\.pm$'
    execute ":silent! normal ^i#\<ESC>\<down>^"
  " for .tex files use %
  elseif file_name =~ '\.tex$' || file_name =~ '\.nw$' || file_name =~ '\.M$' || file_name =~ '\.m$'
    execute ":silent! normal ^i%\<ESC>\<down>^"
